...
type declineReservationModalProps = {
  bookingId: number;
  declineMutation: UseMutationResult<
    AxiosResponse<any, any>,
    Error,
    declineReservationData,
    unknown
  >;
};

const DeclineReservationModal = ({
  bookingId,
  declineMutation,
}: declineReservationModalProps) => {
  ...
  const onSubmit: SubmitHandler<declineReservationSchemaType> = async (
    data,
  ) => {
    setIsLoading(true);
