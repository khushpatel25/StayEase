...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse verifyEmail(Integer id, String email) {
        ...
        if (user.getEmail().equals(email)) {
            ...
            return AuthenticationResponse.builder().message("Account Email Verification Successful")
                    .token(jwtToken)
                    .success(true)
                    .build();
        }
    ...
    public AuthenticationResponse register(RegisterRequest request) throws MessagingException {
        ...
        String body = "<p>Click the <a href=https://stayeasee.netlify.app/confirm_registration?id="
                + user.getUserId() + "&email=" + user.getEmail()
    ...
    public AuthenticationResponse forgotPassword(AuthenticationRequest request) {
        ...
        String htmlContent = "<p>Click the <a href=https://stayeasee.netlify.app" + "/confirm_password?resetToken="
                + resetToken + "&id=" + user.getUserId()
                + ">link</a> to reset your password </p>";

        emailService.sendEmail(request.getEmail(), "Reset Password", htmlContent);

        return AuthenticationResponse.builder().message("email sent successfully").success(true)
                .build();
    ...
    public AuthenticationResponse resetPassword(String token, Integer id) {
        ...
        if (user.getUserId().equals(tokenId)) {
            return AuthenticationResponse.builder().message("Verification done successfully")
                    .success(true).build();
        }
    ...
    public AuthenticationResponse setNewPassword(PasswordResetRequest request) {
        ...
        repository.save(user);
        return AuthenticationResponse.builder().message("Password Reset Successful").success(true)
                .build();
